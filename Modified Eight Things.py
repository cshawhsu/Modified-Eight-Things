...
sizeItemRepLayer = 16 #ize of first item hidden layer
sizeContextRepLayer = 8  #size of first context hidden layer
sizeSecondLayer = 20  #size of second hidden layer
...
W1_context = tf.Variable(tf.random_uniform([sizeContextRepLayer,nSizeofContextInput],-1,1))*0.05 #weights from context input to context hidden layer1
B1_context = tf.Variable(tf.random_uniform([sizeContextRepLayer,1],-1,1))*0.05 #bias from context input to context hidden layer1
...
W2_context = tf.Variable(tf.random_uniform([sizeSecondLayer,sizeContextRepLayer],-1,1))*0.05 #weights from context hidden layer1 to layer2
B2_context = tf.Variable(tf.random_uniform([sizeSecondLayer,1],-1,1))*0.05 #bias from context hidden layer1 to layer2
